              ...
              <section class="panel panel-default">
                <div class="row m-l-none m-r-none bg-light lter">
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                    ...
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong><?=$semuter;?></strong></span>
                      <small class="text-muted text-uc">Semut Member</small>
                    </a>
                  </div>
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                    ...
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong id="bugs"><?=$onlinesemuter;?></strong></span>
                      <small class="text-muted text-uc">Online member</small>
                    </a>
                  </div>
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light">                     
                    <span class="fa-stack fa-2x pull-left m-r-sm">
                    ...
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong id="firers"><?=$tags;?></strong></span>
                      <small class="text-muted text-uc">Tags Posted</small>
                    </a>
                  </div>
                  <div class="col-sm-6 col-md-3 padder-v b-r b-light lt">
                    <span class="fa-stack fa-2x pull-left m-r-sm">
                    ...
                    <a class="clear" href="#">
                      <span class="h3 block m-t-xs"><strong><?=$checkins;?></strong></span>
                      <small class="text-muted text-uc">Taxi Requests</small>
                    </a>
                  </div>
                </div>
              </section>
                ...
                <div class="col-md-4">
                  <section class="panel panel-default portlet-item">
                    <header class="panel-heading">
                      Member Poin Ranking <span class="badge bg-info">5</span>                    
                    </header>
