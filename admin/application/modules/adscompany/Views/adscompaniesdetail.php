    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url(); ?>adscompany">Ads Companies</a></li>
				<li class="active">Detail Ads Company</li>
			</ol>
		</div><!--/.row-->	
				...
				<div class="panel panel-default">
					<div class="panel-body tabs">
						...
						<ul class="nav nav-pills">
							<li class="active"><a href="#pilltab1" data-toggle="tab">Detail Ads Company</a></li>
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade" id="pilltab2">
				                <form action="<?php echo base_url(); ?>adscompany/edit" method="post" role="form">
