    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Ads Companies</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">List of Ads Companies</div>
					<div class="panel-body">
                        <form action="adscompany" method="post" role="form">
                            <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <a href="<?php echo base_url(); ?>adscompany">All City</a>
                            </div>
                        </form>
                            </div>
                        <div class="col-md-6">
                            <a href="adscompany/create"><button class="btn btn-primary"><span class="glyphicon glyphicon-plus-sign"></span>   New Ads Company</button></a>
                        </div>
                        <div class="col-md-12">
                        <hr>
						<table data-toggle="table" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="asc">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="adscompany/detail/<?=$unit->ID;?>"><span class="glyphicon glyphicon-menu-hamburger"></span>&nbsp;Detail</a></td>
                                </tr>
                                <?php }} ?>
                            </tbody>
						</table>
